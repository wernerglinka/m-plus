...
const replace = ({
  ...
  if (path.basename(transformed) === path.basename(options.directoryIndex, path.extname(options.directoryIndex))) transformed = path.dirname(transformed);
